...
class FastLZWCompressor : public Object {
    GDCLASS(FastLZWCompressor, Object)

protected:
    static void _bind_methods() {
        ClassDB::bind_static_method("FastLZWCompressor", D_METHOD("compress", "src", "color_buf"),&FastLZWCompressor::compress);
    }
